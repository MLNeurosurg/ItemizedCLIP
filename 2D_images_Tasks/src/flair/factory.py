"""
This code is adapted from FLAIR: 
https://github.com/ExplainableML/flair/blob/main/src/flair/factory.py

which was from OpenCLIP:
...
from .model import convert_weights_to_lp, convert_to_custom_text_state_dict, \
    resize_pos_embed, get_cast_dtype, resize_text_pos_embed, set_model_preprocess_cfg, ItemizedCLIP
...
from .loss import ItemizedCLIPLoss
...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        model_cfg['visproj'] = args.use_flair_loss
...
def create_loss(args):
    ...
    if args.use_flair_loss:
        return ItemizedCLIPLoss(rank=args.rank,
                            ...
                            added_mps_loss=True, iis_loss = args.iis_loss, mps_fac = args.mps_fac, 
                            maskposrate = args.ila_mask_rate, ila_fac = args.ila_fac,comp_upfac=args.comp_upfac,key_token_alignment_loss=args.key_token_alignment_loss,key_token_thresh=args.key_token_thresh,
                            )
