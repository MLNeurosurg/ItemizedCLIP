"""
The only changes made by ItemizedCLIP (from FLAIR repo, https://github.com/ExplainableML/flair/blob/main/src/flair/transformer.py) is allowing passing in the attention mask into PureAttentionPoolingBlock for TCS masking

Original FLAIR repo comments:
